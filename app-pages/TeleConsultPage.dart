...
import 'tele_consult_page_model.dart';
export 'tele_consult_page_model.dart';

class TeleConsultPageWidget extends StatefulWidget {
  const TeleConsultPageWidget({Key? key}) : super(key: key);

  @override
  _TeleConsultPageWidgetState createState() => _TeleConsultPageWidgetState();
}

class _TeleConsultPageWidgetState extends State<TeleConsultPageWidget>
    with TickerProviderStateMixin {
  late TeleConsultPageModel _model;
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      ...
                                      queryParameters: {
                                        ...
                                        'nurseConsultPrice': serializeParam(
